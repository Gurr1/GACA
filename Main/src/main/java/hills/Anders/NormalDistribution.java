...
public class NormalDistribution {
     ...
     * @param x the value to be calculated in f(x) = y
     * @param maen the maen value in the normal dist. function were f(x) reaches it's peak value
     * @param sDeviation the standard deviation for the normal distribution function
    ...
    /**
     * Calculates the value y for the normal distribution function with the maen value to 0
     * @param x the value to be calculated in f(x) = y
     * @param sDeviation the standard deviation for the normal distribution function
     * @return the value y in the equation f(x)=y
     */
    ...
    /**
     * Calculates the value y for the normal distribution function
     * and adapt the value to fit the interval between the min and max value
     * @param x the value to be calculated in f(x) = y
     * @param maen the maen value in the normal dist. function were f(x) reaches it's peak value
     * @param sDeviation the standard deviation for the normal distribution function
     ...
     * @return the value y in the equation f(x)=y
     */
    public static double solve(double x, double maen, double sDeviation, double min, double max) {
        return interval(x, maen, sDeviation, max - min) + min;
    }

    /**
     * Calculates the value y for the normal distribution function
     * and adapts it to fit in the interval between 0 and diff
     * @param x the value to be calculated in f(x) = y
     * @param maen the maen value in the normal dist. function were f(x) reaches it's peak value
     * @param sDeviation the standard deviation for the normal distribution function
     * @param diff fits the y-value to the value of diff
     * @return the value y in the equation f(x)=y
     */
    private static double interval(double x, double maen, double sDeviation, double diff) {
