...
public class RandomWalker {
    ...
    float generate(float x)
    {
        ...
        float toFlooredInt = fromFlooredInt - 1.0f;

        float gradient1, gradient2;

        float t0 = 1.0f - fromFlooredInt * fromFlooredInt;
        t0 *= t0;
        gradient1 = t0 * t0 * grad(permOriginal[flooredX & 0xff], fromFlooredInt);
