...
public class Clock {
	...
	public static final double TICKS_PER_SECOND = 1000000000.0; // 1 tick per nanosecond
	...
	private float scale =      1.0f;  // Clock speed scale relative to real life speed. Default 1.0f
	...
	/**
	 * Should be called once every game loop cycle with "real time" passed in seconds.<br>
	 * <br>
	 * Updates clock ticks
	 */
	 ...
	 * @param targetFPS - Time step reference.
	 */
	 ...
	 * @param ticks - Amount of ticks to be converted.
	...
	/**
	 * @return Time passed since last mark in seconds. Can be negative if setTime(float) has been used!
	 */
