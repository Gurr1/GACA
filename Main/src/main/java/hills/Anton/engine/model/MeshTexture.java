...
public class MeshTexture {
	...
	public MeshTexture(String diffuse, String normal, String occlusion, String opacity, String specularGloss, String emissive){
		this.diffuse = diffuse == null ? -1 : TextureLoader.loadTexture(diffuse);
		this.normal = normal == null ? -1 : TextureLoader.loadTexture(normal);
		this.occlusion = occlusion == null ? -1 : TextureLoader.loadTexture(occlusion);
		this.opacity = opacity == null ? -1 : TextureLoader.loadTexture(opacity);
		this.specularGloss = specularGloss == null ? -1 : TextureLoader.loadTexture(specularGloss);
		this.emissive = emissive == null ? -1 : TextureLoader.loadTexture(emissive);
	}
	
	public MeshTexture(String diffuse, String normal, String occlusion, String opacity, String specularGloss){
		this(diffuse, normal, occlusion, opacity, specularGloss, null);
	}
	
	public MeshTexture(String diffuse, String normal, String occlusion, String opacity){
