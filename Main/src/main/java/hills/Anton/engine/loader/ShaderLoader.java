...
public class ShaderLoader {
	...
	public static final String SHADER_DIRECTORY = "src/main/resources/shaders/";
	...
	public static int load(String fileName, int type){
		...
		try{
			BufferedReader reader = new BufferedReader(new FileReader(SHADER_DIRECTORY + fileName)); // Reader to read source code from file
