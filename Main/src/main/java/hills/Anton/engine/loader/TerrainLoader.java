	...
	public static Mesh loadGridMesh(int width, int depth){
		...
		for(int tileZ = 0; tileZ < depth; tileZ++)
			for(int tileX = 0; tileX < width; tileX++){
				...
				ver[currentTileIndex * 4 + 0] = new Vertex(new Vec3(tileX, 0.0f, tileZ), new Vec2((float) tileX / width, 1.0f - ((float) tileZ / depth)), new Vec3(0.0f, 1.0f, 0.0f));
				ver[currentTileIndex * 4 + 1] = new Vertex(new Vec3(tileX + 1, 0.0f, tileZ), new Vec2((float) tileX / width, 1.0f - ((float) tileZ / depth)), new Vec3(0.0f, 1.0f, 0.0f));
				ver[currentTileIndex * 4 + 2] = new Vertex(new Vec3(tileX + 1, 0.0f, tileZ + 1), new Vec2((float) tileX / width, 1.0f - ((float) tileZ / depth)), new Vec3(0.0f, 1.0f, 0.0f));
				ver[currentTileIndex * 4 + 3] = new Vertex(new Vec3(tileX, 0.0f, tileZ + 1), new Vec2((float) tileX / width, 1.0f - ((float) tileZ / depth)), new Vec3(0.0f, 1.0f, 0.0f));
