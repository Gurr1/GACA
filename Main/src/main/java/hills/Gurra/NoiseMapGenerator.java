 ...
 */
public class NoiseMapGenerator { // This file should be cleaned up for
									// readability.
	private final int WIDTH = 1056;
	private final int HEIGHT = 1056;

	private static final double FEATURE_SIZE = 24; // >Zooms in on the picture,
	...
	public void create2DNoiseImage(String name, double frequency, double scale) { // this
																					// should
																					// probably
																					// be
																					// created
		...
		try {
			ImageIO.write(image, "png", new File("src/main/resources/" + name
					+ ".png"));
