...
public class EntityFactory {
    ...
    public static CollectibleObject createCoin(Model model, Vec3 position) {return new Coin(position, model); }

    public static Bug createBug(Model model, Vec3 position){
